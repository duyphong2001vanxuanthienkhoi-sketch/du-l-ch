...
const Footer = () => {
    ...
    const linkSections = [
        ...
        {
            title: t("LIÊN HỆ", "CONTACT", "联系"),
            links: [
                { text: "+84 788 310 268", path: '/', icon: PhoneIcon },
                { text: "chosohonggai@gmail.com", path: '/', icon: MailIcon },
                { text: t("Phường Hồng Gai, Quảng Ninh", "Hong Gai Ward, Quang Ninh", "广宁省鸿基坊"), path: '/', icon: MapPinIcon }
            ]
        }
    ];
