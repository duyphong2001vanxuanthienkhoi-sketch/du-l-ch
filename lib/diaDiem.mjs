// DỮ LIỆU MỒI của 11 địa điểm Hồng Gai — nội dung biên tập sẵn, đủ ba thứ tiếng.
//
// ĐÂY KHÔNG CÒN LÀ NGUỒN CHẠY THẬT. Từ giai đoạn 1, địa điểm sống trong bảng dia_diem
// và được sửa qua /admin/dia-diem. File này chỉ dùng để NẠP LẦN ĐẦU:
//     npm run nap-dia-diem          (hoặc bấm nút trong /admin/dia-diem)
//
// Để đuôi .mjs vì file thuần ESM không import gì — nhờ vậy script Node chạy thẳng được
// (package.json không có "type": "module" nên file .js sẽ bị Node đọc theo CommonJS).
//
// Trường chữ là mảng [vi, en, zh]. Trường KHÔNG dịch: id, mau, icon, toạ độ, lanCan.
// Ảnh: thả file vào public/dia-diem/<id>.jpg (thêm -2, -3... cho ảnh phụ).
...
export const DIA_DIEM = [
    ...
    },
    {
        ...
        gioiThieu: [
            ...
            [
                'Với du khách, đây là nơi cảm nhận rõ nhất nhịp sống phố biển: nếm thử chả mực nóng, mua ruốc tôm và hải sản khô làm quà, trò chuyện với tiểu thương đã bán ở đây mấy chục năm.',
                'For visitors, this is where the rhythm of coastal life is most tangible: taste hot grilled squid cake, buy shrimp floss and dried seafood as gifts, and chat with vendors who have traded here for decades.',
                '对游客而言，这里最能感受海滨小城的生活节奏：品尝热腾腾的墨鱼饼，选购虾松和海鲜干货作伴手礼，与在此经营数十年的商户闲话家常。',
            ],
        ],
        diemNoiBat: [
            ...
            ['Nếm chả mực nóng tại chỗ và mua đặc sản khô làm quà', 'Taste hot grilled squid cake on the spot and buy dried specialties as gifts', '现场品尝热墨鱼饼，选购干货特产作伴手礼'],
        ],
        thongTin: {
