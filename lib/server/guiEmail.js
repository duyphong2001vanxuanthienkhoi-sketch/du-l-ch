...
// (tùy chọn) BREVO_TU_TEN — tên hiển thị của người gửi, mặc định "Khám Phá Hồng Gai"
//
...
export async function guiEmail({ den, tieuDe, html }) {
    ...
    const res = await fetch('https://api.brevo.com/v3/smtp/email', {
        ...
        body: JSON.stringify({
            sender: {
                name: process.env.BREVO_TU_TEN || 'Khám Phá Hồng Gai',
    ...
    <div style="background:#f1f5f9;padding:32px 16px;font-family:Arial,Helvetica,sans-serif">
        <div style="max-width:480px;margin:0 auto;background:#ffffff;border-radius:16px;overflow:hidden">
            <div style="background:#059669;padding:20px 28px">
                <p style="margin:0;color:#ffffff;font-size:20px;font-weight:bold">Khám Phá Hồng Gai</p>
        ...
        <p style="text-align:center;color:#94a3b8;font-size:11px;margin:16px 0 0">© Khám Phá Hồng Gai — Phường Hồng Gai, Quảng Ninh</p>
    </div>`
}
